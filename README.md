...
| 5（国庆节调休） | 盲目式搜索+Python实现      | 盲目式搜索-DFS+Python实现 [pdf](https://github.com/wanyongquan/IntroductionToAI/blob/main/slides/lecture05/lecture05-uninformed%20search-DFS.pdf)                                          | 3.2      | proj1    |          |
